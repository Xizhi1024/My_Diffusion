...
def main():
    ...
    ap.add_argument(
        ...
        choices=["mean", "median"],
        default=None,
        help="Point estimator for MC samples (default: evaluation.mc_aggregate or mean)",
    )
    ...
    mc_aggregate = (
        args.mc_aggregate
        if args.mc_aggregate is not None
        else str(eval_cfg.get("mc_aggregate", "mean"))
    )
